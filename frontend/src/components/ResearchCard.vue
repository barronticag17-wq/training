<template>
  <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:border-green-200 hover:shadow-xl transition-all flex flex-col group relative overflow-hidden">
    <div 
      v-if="user"
    ...
    <div class="mt-auto border-t border-gray-50 pt-6 space-y-4">
      ...
      <div class="flex gap-2">
        ...
        <template v-if="user?.role === 'Admin'">
          ...
          <button @click="$emit('archive', item.id)" class="p-3 bg-red-50 text-red-600 hover:bg-red-100 rounded-2xl transition-all">
